...
public class ParaEntityBullet extends Entity implements IProjectile, IThrowableEntity {
	private int xTile = -1;
	private int yTile = -1;
	private int zTile = -1;
	private int inTile;
	...
	public ParaEntityBullet(World par1World) {
		super(par1World);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	}

	public ParaEntityBullet(EntityPlayer par2EntityPlayer, World par1World, double par2, double par4, double par6) {
		super(par1World);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	...
	public ParaEntityBullet(World par1World, EntityLivingBase par2EntityLivingBase,
	...
	public ParaEntityBullet(World par1World, EntityLivingBase par2EntityLivingBase, float par3) {
		super(par1World);
		this.renderDistanceWeight = 10.0D;
		this.shootingEntity = par2EntityLivingBase;
			...
			if (movingobjectposition != null) {
				if (movingobjectposition.entityHit != null) {
					...
					if (this.shootingEntity == null) {
						damagesource = Psycho_pass_core.causeTestParaDamage(this, this);
					} else {
						damagesource = Psycho_pass_core.causeTestParaDamage(this, this.shootingEntity);
					}
